		...
		<form class="form__body" action="" method="post">
			<div class="form__item">
				<label class="form__label">
					<input class="form__input form__input_text" placeholder="Имя ползователя" type="text" name="name" value="<?php echo $message['name']; ?>">
				</label>
				<?php echo $message['name-error']; ?>
			</div>
			<div class="form__item">
				<label class="form__label">
					<input class="form__input form__input_text" placeholder="E-mail пользователя" type="text" name="email" value="<?php echo $message['email']; ?>">
				</label>
			...
			<div class="form__item">
				<label class="form__label">
					<select name="year" class="form__select">
						<option value="" class="form__option">Год рождения</option>
						<?php
						for ($i = 2008; $i >= 1900; --$i) {
							if ($i == $message['year']) {
			...
			<div class="form__item form__item_numlimbs">
				<span class="form__span">Кол-во конечностей</span>
				<div class="form__container">
					<?php
					for ($i = 1; $i <= 4; $i++) {
			...
			<div class="form__item">
				<label class="form__label">
					<textarea class="form__textarea" placeholder="О себе" name="biography"><?php echo $message['biography']; ?></textarea>
				</label>
				<?php echo $message['biography-error'] ?>
			</div>
			<div class="form__item form__item_agreement">
				<label class="form__label">
					<input class="form__input" type="checkbox" name="agree" required>Согласие на обработку персональных данных пользователя
				</label>
			</div>
